...
<!-- Don't remove this --- https://github.com/piyush-taneja -->
<!-- section - intro -->
# Product Manager | Fintech & Digital Public Infrastructure | Ex-Software Engineer
Hi, I'm Piyush Taneja — a **Product Manager** working on Digital Public Infrastructure in fintech, with an engineering background and an MBA from IIM Udaipur. ✌
<!-- section - intro -->
...
<!-- section - skills -->
## I work on ..
Product Strategy . Fintech & Digital Public Infrastructure . API Ecosystems . Compliance & GenAI
Python . SQL . Machine Learning . RAG Architectures
PHP . MySQL . JavaScript . C++ . Java
<!-- section - skills -->
<!-- section - job details -->
## On the job ..
> Product Manager - [**Sahamati Foundation**](https://sahamati.org.in)
...
> Backend Developer Intern - [**MothersonSumi Infotech & Design Limited**](https://www.mind-infotech.com/)
> Web Developer Intern - [**Flaberry.com**](flaberry.com)
<!-- section - job details -->
<!-- section - interests -->
## My Absolute Favorites ..
🦄 Product thinking & building for scale
👨‍💻 Systems that sit at the intersection of tech & policy
📰 Reading & writing on fintech and product
